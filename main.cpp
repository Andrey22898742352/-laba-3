...
int main()
{
    ...
    State secondState(true);
    State thirdState(true);

   

    TransitionFunction<char> c(firststate, secondState, 'b');
    TransitionFunction<char> d(thirdState, thirdState, 'a');

    TransitionFunction<char> e(firststate, thirdState, 'a');
    TransitionFunction<char> f(secondState, thirdState, 'b');

    TransitionFunction<char> g(secondState, firstState, 'a');
    TransitionFunction<char> h(firstState, secondState, 'b');

    Automata<char> fsm{ firstState, secondState, thirdState }, { a,b,c,d,e,f,g,h }, {'a','b'};

    std::string parsedString = "bbbabbbbbbba";
